...
public class RandomUtil {
	...
	/*
	 * public static void main(String[] args) { int[] randomNum =
	 * RandomUtil.getRandomNum(2, 9, 3); System.out.println("获得一个区间内的n个不会重复的随机数字:");
	 * for (int i = 0; i < randomNum.length; i++) {
	 * System.out.println(randomNum[i]); } System.out.println("获得随机英文字符:");
	 * System.out.println(RandomUtil.getRandomChar());
	 * System.out.println("获取n位随机英文和数字字符串:");
	 * System.out.println(RandomUtil.getRandomCNumberString(6));
	 * System.out.println("获取1个随机中文字符串:");
	 * System.out.println(RandomUtil.getRandomChineseString());
	 * System.out.println("获得多个中文:");
	 * System.out.println(RandomUtil.getRandomChineseString(3));
	 * System.out.println("取名:"); System.out.println(RandomUtil.getRandomName()); }
	 */
